...
dataset_root = '/Users/junkyungkim/Desktop/'
...
# CONTROL
import cluttered_nist_locctrl as cluttered_nist

args.std_font_sizes = np.array([113, 127, 127])*1.33 #np.array([113, 127, 127])*2
args.target_thickness = 9 # 6
args.marker_radius = 10
...
args.distortion_num_masks = [6] #[10]
...
args.pixelate_patch_size = 4#3
args.pixelate_threshold = 0.3#0.15
args.pixelate_p_omission = 0.15#0.3
args.pixelate_jitter_sigma = 1
